...
const DIFF_BADGE: Record<string, string> = {
  ...
  hard: "bg-rose-500/20 text-rose-600",
    ...
    <div className="flex flex-col gap-4">
      ...
      {problem && (
        <div className="rounded-xl border border-black/[0.08] bg-white p-4">
          ...
          {problem.examples.length > 0 && (
            <div className="mt-2">
              <p className="text-[11px] uppercase tracking-wider text-neutral-400">Examples</p>
              <ul className="mt-1 space-y-0.5 font-mono text-xs text-neutral-600">
          ...
          {problem.constraints.length > 0 && (
            <div className="mt-2">
              <p className="text-[11px] uppercase tracking-wider text-neutral-400">Constraints</p>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-md border border-black/[0.08] bg-black/[0.04] px-2 py-1 text-xs outline-none focus:border-accent/60"
            >
              {LANGUAGES.map((l) => (
          ...
          <textarea
            ...
            className="w-full resize-y rounded-lg border border-black/[0.08] bg-stone-100 px-3 py-2 font-mono text-xs leading-relaxed text-neutral-900 outline-none focus:border-accent/60"
          />
          <button
            onClick={submit}
      ...
      {review && (
        <div className="rounded-xl border border-black/[0.08] bg-white p-4">
          ...
          <p className="text-sm text-neutral-800">{review.correctness}</p>
          ...
          <div className="md mt-2 max-w-none text-xs text-neutral-800">
          ...
          <details className="mt-2">
            ...
            <div className="md mt-1 max-w-none text-xs text-neutral-800">
